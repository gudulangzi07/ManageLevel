package com.mmbuycar.managelevel.framework.bottombar.badgeview;
...
public class BadgeViewHelper {
    ...
    private void initDefaultAttrs(Context context, BadgeGravity defaultBadgeGravity) {
        ...
        mBadgeTextSize = DensityUtil.sp2px(context, 10);
        ...
        mBadgePadding = DensityUtil.dp2px(context, 4);
        mBadgeVerticalMargin = DensityUtil.dp2px(context, 0);

        mBadgeHorizontalMargin = DensityUtil.dp2px(context, 0);
        ...
        mDragExtra = DensityUtil.dp2px(context, 4);
    ...
    public void setBadgeTextSizeSp(int badgetextSize) {
        if (badgetextSize >= 0) {
            mBadgeTextSize = DensityUtil.sp2px(mBadgeable.getContext(), badgetextSize);
            mBadgePaint.setTextSize(mBadgeTextSize);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgeVerticalMarginDp(int badgeVerticalMargin) {
        if (badgeVerticalMargin >= 0) {
            mBadgeVerticalMargin = DensityUtil.dp2px(mBadgeable.getContext(), badgeVerticalMargin);
            mBadgeable.postInvalidate();
        }
    }

    public void setBadgeHorizontalMarginDp(int badgeHorizontalMargin) {
            mBadgeHorizontalMargin = DensityUtil.dp2px(mBadgeable.getContext(), badgeHorizontalMargin);
            mBadgeable.postInvalidate();
    }

    public void setBadgePaddingDp(int badgePadding) {
        if (badgePadding >= 0) {
            mBadgePadding = DensityUtil.dp2px(mBadgeable.getContext(), badgePadding);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgeBorderWidthDp(int badgeBorderWidthDp) {
        if (badgeBorderWidthDp >= 0) {
            mBadgeBorderWidth = DensityUtil.dp2px(mBadgeable.getContext(), badgeBorderWidthDp);
            mBadgeable.postInvalidate();
        }
    }
