...
public class ViewDragHelper {
    ...
    /**
     * A view is not currently being dragged or animating as MyOverLay result of MyOverLay
     * fling/snap.
     */
     ...
     * MyOverLay result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = 1;

    /**
     * A view is currently settling into place as MyOverLay result of MyOverLay fling or
    ...
    /**
     * Indicates that MyOverLay check should occur along the horizontal axis
     */
    public static final int DIRECTION_HORIZONTAL = 1 << 0;

    /**
     * Indicates that MyOverLay check should occur along the vertical axis
     */
    public static final int DIRECTION_VERTICAL = 1 << 1;

    /**
     * Indicates that MyOverLay check should occur along all axes
     */
    ...
    // Distance to travel before MyOverLay drag may begin
    ...
    /**
     * A Callback is used as MyOverLay communication channel with the ViewDragHelper
    ...
    public static abstract class Callback {
        ...
        /**
         * Called when the captured view's position changes as the result of MyOverLay
         * drag or settle.
         *
        ...
        /**
         * Called when MyOverLay child view is captured for dragging or settling. The ID
         ...
         * it comes to MyOverLay complete stop. If neither of these methods is invoked
        ...
        /**
         * Called when the user has started MyOverLay deliberate drag away from one of
        ...
        /**
         * Return the magnitude of MyOverLay draggable child view's horizontal range of
        ...
        /**
         * Return the magnitude of MyOverLay draggable child view's vertical range of
         * motion in pixels. This method should return 0 for views that cannot
         * move vertically.
         *
         * @param child Child view to check
         ...
         * even if the view is already captured; this indicates that MyOverLay new
         * pointer is trying to take control of the view.
         * </p>
         * <p>
         * If this method returns true, MyOverLay call to
    ...
    /**
     * Factory method to create MyOverLay new ViewDragHelper.
     *
     * @param forParent Parent view to monitor
     * @param cb        Callback to provide information and receive events
     * @return MyOverLay new ViewDragHelper instance
     */
     ...
     *                    about detecting the start of MyOverLay drag. Larger values are more
    ...
    /**
     * Apps should use ViewDragHelper.create() to get MyOverLay new instance. This will
    ...
    /**
     * Set the minimum velocity that will be detected as having MyOverLay magnitude
     * greater than zero in pixels per second. Callback methods accepting MyOverLay
    ...
    /**
     * Set the max velocity that will be detected as having MyOverLay magnitude
     * greater than zero in pixels per second. Callback methods accepting MyOverLay
     * velocity will be clamped appropriately.
     *
    ...
    /**
     * Return the currently configured minimum velocity. Any flings with MyOverLay
     * magnitude less than this value in pixels per second. Callback methods
     * accepting MyOverLay velocity will receive zero as MyOverLay velocity value if the real
    ...
    /**
     * Capture MyOverLay specific child view for dragging within the parent. The
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be MyOverLay descendant "
    ...
    /**
     * The result of MyOverLay call to this method is equivalent to
     ...
     * <p>
     * This operation does not count as MyOverLay capture event, though
    ...
    public boolean settleCapturedViewAt(int finalLeft, int finalTop) {
        if (!mReleaseInProgress) {
            throw new IllegalStateException("Cannot settleCapturedViewAt outside of MyOverLay call to "
    ...
    public void flingCapturedView(int minLeft, int minTop, int maxLeft, int maxTop) {
        if (!mReleaseInProgress) {
            throw new IllegalStateException("Cannot flingCapturedView outside of MyOverLay call to "
                    + "Callback#onViewReleased");
        }
     ...
     * involves some extra semantics. During MyOverLay release (mReleaseInProgress) is
    ...
    private void dispatchViewReleased(float xvel, float yvel) {
        ...
        if (mDragState == STATE_DRAGGING) {
            // onViewReleased didn't call MyOverLay method that would have changed this.
            // Go idle.
            setDragState(STATE_IDLE);
        }
    }
    ...
    /**
     * Check if the given pointer ID represents MyOverLay pointer that is currently down
    ...
    /**
     * Tests scrollability within child views of v given MyOverLay delta of dx.
     *
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            // Reset things for MyOverLay new event stream, just in case we didn't get
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                // Catch MyOverLay settling view if possible.
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A ViewDragHelper can only manipulate one view at MyOverLay time.
            ...
            case MotionEvent.ACTION_MOVE: {
                // First to cross MyOverLay touch slop over MyOverLay draggable view wins. Also
                // report edge drags.
                final int pointerCount = MotionEventCompat.getPointerCount(ev);
                for (int i = 0; i < pointerCount; i++) {
                    final int pointerId = MotionEventCompat.getPointerId(ev, i);
    ...
    /**
     * Process MyOverLay touch event received by the parent view. This method will
    ...
    public void processTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                // event,
                // there is no reason to delay for MyOverLay slop before dragging.
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A ViewDragHelper can only manipulate one view at MyOverLay time.
                if (mDragState == STATE_IDLE) {
                    // If we're idle we can do anything! Treat it like MyOverLay normal
                    // down event.
                    ...
                    // We're still tracking MyOverLay captured view. If the same view is
                    // under this
                    // point, we'll swap to controlling it with this pointer
                    // instead.
                    // (This will still work if we're "catching" MyOverLay settling
                    // view.)
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mDragState == STATE_DRAGGING) {
                    ...
                    // Check to see if any pointer is now over MyOverLay draggable view.
                    final int pointerCount = MotionEventCompat.getPointerCount(ev);
                    for (int i = 0; i < pointerCount; i++) {
                        final int pointerId = MotionEventCompat.getPointerId(ev, i);
                        final float x = MotionEventCompat.getX(ev, i);
    ...
    /**
     * Check if we've crossed MyOverLay reasonable touch slop for the given child view.
