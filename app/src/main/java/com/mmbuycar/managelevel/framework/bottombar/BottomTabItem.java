...
import com.mmbuycar.managelevel.framework.bottombar.badgeview.BadgeRelativeLayout;
import com.mmbuycar.managelevel.framework.bottombar.badgeview.Badgeable;
import com.mmbuycar.managelevel.framework.bottombar.badgeview.DragDismissDelegate;
...
public class BottomTabItem extends BadgeRelativeLayout {
    ...
    private void initPaint() {
        ...
        mTextPaint.setTextSize(DensityUtil.sp2px(mContext, mTextSize));
    ...
    static class Builder {
        ...
        BottomTabItem build() {
            BottomTabItem item = new BottomTabItem(context);
