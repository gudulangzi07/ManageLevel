...
public class ExplosionAnimator extends ValueAnimator {
    ...
    public ExplosionAnimator(DragBadgeView dragBadgeView, Rect rect, Bitmap bitmap) {
        ...
        X = DensityUtil.dp2px(dragBadgeView.getContext(), 5);
        Y = DensityUtil.dp2px(dragBadgeView.getContext(), 20);
        V = DensityUtil.dp2px(dragBadgeView.getContext(), 2);
        W = DensityUtil.dp2px(dragBadgeView.getContext(), 1);
