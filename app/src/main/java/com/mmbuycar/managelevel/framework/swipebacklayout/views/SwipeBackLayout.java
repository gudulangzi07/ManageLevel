package com.mmbuycar.managelevel.framework.swipebacklayout.views;
...
import com.mmbuycar.managelevel.framework.swipebacklayout.utils.ViewDragHelper;
 ...
 * @author: 张京伟
 * @date: 2016/3/14 15:40
 * @Description:
 * @version: 1.0
 */
public class SwipeBackLayout extends FrameLayout {
    /**
     * Minimum velocity that will be detected as MyOverLay fling
     */
    ...
    /**
     * Set MyOverLay color to use for the scrim that obscures primary content while MyOverLay
     * drawer is open.
     *
    ...
    /**
     * Register MyOverLay callback to be invoked when MyOverLay swipe event is sent to this
     * view.
     *
    ...
    /**
     * Add MyOverLay callback to be invoked when MyOverLay swipe event is sent to this view.
     *
     * @param listener the swipe listener to attach to this view
     */
    ...
    /**
     * Removes MyOverLay listener from the set of listeners
     *
     * @param listener
     */
    ...
    /**
     * Set MyOverLay drawable used for edge shadow.
     *
